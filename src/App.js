...
function App() {
	useEffect(() => {
		animate(
			"#vinyl",
			{ rotate: [0, 360] },
			{ duration: 1, easing: "linear", repeat: Infinity }
		);
		// timeline([
	...
	return (
		<div className="App">
			<CookieConsent
				...
				location="middle"
			>
				By using our website you agree to the use of Cookies to help ensure the
				site runs smoothly.{" "}
			</CookieConsent>
			<Router>
				<Menu
				...
				<Routes>
					<Route
						path="/"
						element={<Homepage isSmallScreen={isSmallScreen} isOpen={isOpen} />}
					></Route>
					<Route
						path="/flexible-mgmt"
						element={
